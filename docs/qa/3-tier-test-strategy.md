...
- `trainer.starter@test.com` (Password: TestPass123!) - Starter tier
- `trainer.professional@test.com` (Password: TestPass123!) - Professional tier
- `trainer.enterprise@test.com` (Password: TestPass123!) - Enterprise tier
