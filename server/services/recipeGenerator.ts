          ...
          for (const generatedRecipe of generatedRecipes) {
            try {
              const recipeData: InsertRecipe = {
                ...
                proteinGrams: Number(generatedRecipe.estimatedNutrition.protein).toFixed(2),
                carbsGrams: Number(generatedRecipe.estimatedNutrition.carbs).toFixed(2),
                fatGrams: Number(generatedRecipe.estimatedNutrition.fat).toFixed(2),
