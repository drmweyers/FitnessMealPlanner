...
brandingRouter.put(
  ...
  async (req, res) => {
    try {
      ...
      const settings = await brandingService.updateBrandingSettings(
        trainerId,
        updates,
        req,
      );
  ...
  async (req, res) => {
    try {
      ...
      const currentSettings =
        await brandingService.getBrandingSettings(trainerId);
...
brandingRouter.post(
  ...
  async (req, res) => {
    try {
      ...
      const settings = await brandingService.enableWhiteLabel(
        trainerId,
        enabled,
        req,
      );
...
brandingRouter.post(
  ...
  async (req, res) => {
    try {
      ...
      const result = await brandingService.setCustomDomain(
        trainerId,
        customDomain,
        req,
      );
