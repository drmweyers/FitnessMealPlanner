...
export default function Settings() {
  const { user } = useAuth();
  const { tierName, tierLevel, accessibleRecipeCount, monthlyAllocation } =
    useTierInfo();
          ...
          {(canUpgradeToProfessional || canUpgradeToEnterprise) && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Get access to more recipes and features
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 border border-purple-200 rounded-lg bg-purple-50">
                    <div>
                      ...
                      <p className="text-sm text-purple-700">
                        3,000 recipes + 50 new recipes/month
                      </p>
                      <p
                  ...
                  <div className="flex items-center justify-between p-4 border border-amber-200 rounded-lg bg-amber-50">
                    <div>
                      ...
                      <p className="text-sm text-amber-700">
                        6,000 recipes + 100 new recipes/month
                      </p>
                ...
                {canDowngradeToStarter && (
                  <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        1,500 recipes + 25 new recipes/month
                      </p>
                      <p className="text-sm text-slate-500 mt-2">
                        Save $100/month
                      </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-sm text-slate-600">
                  Access the Stripe billing portal to update payment methods,
