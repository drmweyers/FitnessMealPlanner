  ...
  const parseMutation = useMutation({
    mutationFn: async (text: string) => {
      const response = await apiRequest(
        "POST",
        "/api/trainer/parse-manual-meals",
        { text },
      );
        ...
        if (nutritionMode === "daily-total" && meals.length > 0) {
          mealNutrition = {
            calories: dailyNutrition.calories
              ? Math.round(dailyNutrition.calories / meals.length)
              : undefined,
            protein: dailyNutrition.protein
              ? Math.round(dailyNutrition.protein / meals.length)
              : undefined,
            carbs: dailyNutrition.carbs
              ? Math.round(dailyNutrition.carbs / meals.length)
              : undefined,
            fat: dailyNutrition.fat
              ? Math.round(dailyNutrition.fat / meals.length)
              : undefined,
          };
        }
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Manual entry - No AI costs, instant creation with optional nutrition
          tracking
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription>
            <strong>Two ways to create:</strong> Paste meal text for
            auto-parsing, or add meals manually. Nutrition is optional - leave
            blank to show "Not calculated".
          </AlertDescription>
        </Alert>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div>
                            ...
                            <Select
                              value={meal.category}
                              onValueChange={(cat) =>
                                updateMealCategory(index, cat as MealCategory)
                              }
                            >
                              <SelectTrigger>
                                <SelectValue />
          ...
          <>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1 mb-2">
                Categorize this plan by meal type. Locked types require tier
                upgrade.
              </p>
              <MealTypeDropdown
            ...
            {nutritionMode === "daily-total" && (
              <Card className="p-4 bg-blue-50">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  These values will be distributed evenly across {meals.length}{" "}
                      ...
                      <div className="grid grid-cols-4 gap-2 mt-3 pt-3 border-t">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              updateMealNutrition(index, "fat", e.target.value)
                            }
                          />
                        </div>
                      </div>
