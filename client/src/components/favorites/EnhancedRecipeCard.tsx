      ...
      >
        ...
        <div
          className={cn(
            ...
            isListLayout
              ? "w-32 sm:w-40 flex-shrink-0"
              : `w-full ${config.imageHeight}`,
          )}
        >
        ...
        {/* Content Section */}
        <CardContent
          className={cn(config.contentPadding, "flex flex-col h-auto flex-1")}
        >
          ...
          <div className="mb-2 sm:mb-3 flex flex-wrap gap-1 sm:gap-2">
            ...
            >
              {primaryMealType.charAt(0).toUpperCase() +
                primaryMealType.slice(1)}
            </div>
            {primaryDietaryTag && (
              <span
                className={cn(
          ...
          {showEngagementStats && engagementData && !isListLayout && (
            <div
              className={cn(
                "flex items-center gap-3 mb-3 text-slate-600",
                config.metaSize,
              )}
            >
              {engagementData.viewCount !== undefined && (
