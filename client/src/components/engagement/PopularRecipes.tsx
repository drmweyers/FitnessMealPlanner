...
const PopularRecipes = memo(
  ({ className, onRecipeClick }: PopularRecipesProps) => {
    ...
    return (
      <div className={cn("w-full space-y-6", className)}>
        ...
        <Tabs
          ...
          onValueChange={(value: any) => setActiveTimeframe(value)}
        >
                      ...
                      .map((item: any, index: number) => (
                        <Card
                          ...
                          className={cn(
                            ...
                            index === 0 &&
                              "lg:col-span-1 ring-2 ring-yellow-200 bg-gradient-to-br from-yellow-50 to-orange-50",
                          )}
