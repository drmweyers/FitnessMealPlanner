...
export default function TrainerMealPlans() {
  ...
  const [selectedPlan, setSelectedPlan] = useState<CustomerMealPlan | null>(
    null,
  );
  const [planToDelete, setPlanToDelete] = useState<string | null>(null);
  const [planToAssign, setPlanToAssign] =
    useState<TrainerMealPlanWithAssignments | null>(null);
  ...
  const assignMealPlan = useMutation({
    ...
    onSuccess: (data, variables) => {
      toast({
        ...
        description:
          "The meal plan has been successfully assigned to the customer.",
      });
      queryClient.invalidateQueries({ queryKey: ["trainer-meal-plans"] });
      ...
      queryClient.invalidateQueries({
        queryKey: ["customerMealPlans", variables.customerId],
      });
  ...
  const filteredPlans = mealPlans.filter(
    (plan: TrainerMealPlanWithAssignments) => {
  ...
  const handleAssignSelected = () => {
    if (!planToAssign || selectedCustomers.length === 0) {
      toast({
        ...
        description:
          "Please select at least one customer to assign the meal plan.",
        variant: "default",
      });
      return;
    }
  ...
  return (
    <div className="space-y-6">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      ...
                      <span>
                        {planData.days} days, {planData.mealsPerDay} meals/day
                      </span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    {plan.assignmentCount !== undefined &&
                      plan.assignmentCount > 0 && (
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          ...
                          <span>
                            Assigned to {plan.assignmentCount} customer
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              be undone. Any assignments to customers will also be removed.
            </DialogDescription>
          </DialogHeader>
          <div className="flex justify-end gap-3 mt-4">
            ...
            <Button
              variant="destructive"
              onClick={() =>
                planToDelete && deleteMealPlan.mutate(planToDelete)
              }
      ...
      <Dialog
        open={!!planToAssign}
        onOpenChange={(open) => !open && handleCloseAssignmentModal()}
      >
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {(planToAssign?.mealPlanData as any)?.planName ||
                "this meal plan"}
              " to.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
              ...
              {isLoadingCustomers ? (
                ...
                <div className="text-center py-8 text-slate-500">
                  ...
                  <p className="text-sm mt-1">
                    Customers will appear here once they accept invitations.
                  </p>
                </div>
              ) : (
            ...
            <div className="flex justify-end gap-3 pt-4 border-t">
              ...
              <Button
                ...
                disabled={
                  assignMealPlan.isPending || selectedCustomers.length === 0
                }
