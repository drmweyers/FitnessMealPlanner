            ...
            <div className="rounded-2xl border border-orange-500/20 bg-gray-900/80 backdrop-blur-xl shadow-2xl shadow-orange-500/5 p-6 sm:p-8">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-300/70 text-sm mt-0.5">
                        ...
                        <strong className="text-emerald-200">
                          {invitationData.trainerEmail}
                        </strong>{" "}
                        to join EvoFitMeals. Complete your registration below to
                        get started.
                      </p>
                    </div>
                  </div>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            ...
                            {...field}
                            className="h-11 sm:h-12 text-sm sm:text-base bg-gray-800/60 border-gray-700/50 text-white placeholder:text-gray-500 focus:border-orange-500 focus:ring-orange-500/20 rounded-lg disabled:bg-gray-800/30 disabled:text-gray-500"
                          />
                        </FormControl>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Select
                            ...
                            disabled={!!invitationData}
                          >
                            <SelectTrigger className="h-11 sm:h-12 text-sm sm:text-base bg-gray-800/60 border-gray-700/50 text-white focus:border-orange-500 focus:ring-orange-500/20 rounded-lg disabled:bg-gray-800/30 disabled:text-gray-500">
              ...
              <div className="relative my-5">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#0A0A0F] px-3 text-gray-500 tracking-wider">
                    or
                  </span>
                </div>
              </div>
              <a
                href={`/api/auth/google/${form.watch("role") || "customer"}`}
                className="w-full inline-flex items-center justify-center gap-3 h-11 sm:h-12 rounded-lg bg-white hover:bg-gray-100 text-gray-800 font-semibold text-sm sm:text-base transition-all duration-200 shadow-lg shadow-black/20"
